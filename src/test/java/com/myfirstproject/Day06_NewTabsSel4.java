...
//        1. open google in the tab 1
        driver.get("https://www.google.com");//no need WebDriver googleTab = driver.switchTo().newWindow(WindowType.TAB);
...
//        Creating and switching to a new EMPTY Tab
       ...
       // driver.switchTo().newWindow(WindowType.TAB);
        amazonTab.get("https://www.amazon.com");//new driver rather than normal driver
...
//      Switching back to amazon tab
        Thread.sleep(3000);
        //driver.switchTo().window(amazonWindowHandle);//created before above
